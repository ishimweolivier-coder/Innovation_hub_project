        ...
        {showForm && (
          <form onSubmit={handleSubmit} className="card p-6 space-y-4 animate-fade-in">
            ...
            <div className="flex gap-3">
              <button type="submit" className="btn-primary text-sm">{editingId ? 'Update Event' : 'Save Event'}</button>
          ...
          {events.map((event) => (
            <div key={event.id} className="card p-5 flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => deleteEvent(event.id)} className="p-2 rounded-lg hover:bg-red-50 text-red-500">
